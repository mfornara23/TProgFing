      ...
      <div class="main-container">
        ...
        <c:forEach items="${espectaculoList}" var="espectaculo">
        	<div style="padding: 3px 0;">
	          <a id="e_${fn:trim(fn:toLowerCase(espectaculo.nombre))}" class="espectaculo-row list-row" href="/corona-ticket-web/FuncionServlet?page=alta&nombre_espec=${espectaculo.nombre}">
