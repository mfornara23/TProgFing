  ...
  <jsp:include page="/WEB-INF/jsp/template/header.jsp" />
	...
	<div id="page-content-wrapper">
        ...
        <div class="title-container" style="align-items: flex-end;justify-content: space-between;padding: 0 50px 0 0;">
          <h1 class="title">Espectáculos Para Valorar</h1>
        </div>
        <c:choose>
        	<c:when test="${empty espectaculoValorarList}">
        		<h1 class="subtitle">No tiene espectaculos para valorar.</h1>		
        	</c:when>
        <c:otherwise>
        <c:forEach items="${espectaculoValorarList}" var="espectaculo">
