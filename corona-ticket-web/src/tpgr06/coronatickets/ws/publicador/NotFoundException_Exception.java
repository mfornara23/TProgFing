 ...
 * 
 */
@WebFault(name = "NotFoundException", targetNamespace = "http://publicador.ws.coronatickets.tpgr06/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: tpgr06.coronatickets.ws.publicador.NotFoundException
     */
